    ...
    egui::SidePanel::left("Menu").show(ctx, |ui| {
        ...
        egui::Frame::new()
            ...
            .show(ui, |ui| {
                ui.vertical(|ui| {
                    // モード切替
                    ui.label(egui::RichText::new("Edit Mode").size(app.config.menu_font_size_mini));

                    ui.radio_value(
                        &mut app.edit_mode,
                        EditMode::default_normal(),
                        egui::RichText::new("Normal [Esc]").size(app.config.menu_font_size_normal),
                    );
                    ui.radio_value(
                        &mut app.edit_mode,
                    ...
                    ui.radio_value(
                        ...
                        egui::RichText::new("Add Edge [E]").size(app.config.menu_font_size_normal),
                    );
                    ui.radio_value(
                        &mut app.edit_mode,
                        EditMode::default_delete(),
                        egui::RichText::new("Delete [D]").size(app.config.menu_font_size_normal),
                    );
                    ...
                    ui.label(
                        egui::RichText::new("Indexing [1]").size(app.config.menu_font_size_mini),
                    );
                    ...
                    ui.radio_value(
                        ...
                        false,
                        egui::RichText::new("Undirected").size(app.config.menu_font_size_normal),
                    );
                    ui.radio_value(
                        &mut app.graph.is_directed,
                        true,
                    ...
                    ui.checkbox(
                        &mut app.is_animated,
                        egui::RichText::new("Animate [A]").size(app.config.menu_font_size_normal),
                    );
                    ...
                    if ui
                        .button(
                            egui::RichText::new("Clear All").size(app.config.menu_font_size_normal),
                        )
                        .clicked()
                    {
                        app.graph.clear();
